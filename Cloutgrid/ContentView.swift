...
//            
//            HStack {
//                TabButton(image: "house", target: .home, selected: $selectedTab)
//                Spacer()
//                TabButton(image: "magnifyingglass", target: .search, selected: $selectedTab)
//                Spacer()
//                TabButton(image: "plus.square", target: .post, selected: $selectedTab)
//                Spacer()
//                TabButton(image: "briefcase", target: .jobs, selected: $selectedTab)
//                Spacer()
//                TabButton(image: "person.circle", target: .profile, selected: $selectedTab)
//            }
